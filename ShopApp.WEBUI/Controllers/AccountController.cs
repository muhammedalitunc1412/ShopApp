    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // email
                await _emailSender.SendEmailAsync(model.Email, "Hesabınızı onaylayınız.", $"Lütfen email hesabınızı onaylamak için linke <a href='https://localhost:44387{url}'>tıklayınız.</a>");
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            // email
            await _emailSender.SendEmailAsync(Email, "Reset Password", $"Parolanızı yenilemek için linke <a href='https://localhost:44387{url}'>tıklayınız.</a>");
